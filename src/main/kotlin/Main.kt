        ...
        while (true) {
            ...
            when (mainMenu.getUserChoice()) {
                0 -> {
                    ...
                    archives.add(Archive(archiveName).apply {
                ...
                1 -> {
                    ...
                    if (archives.isEmpty()) {
                        ...
                        val noteMenu = Menu("Выберите заметку:", archive.notes.map { it.title } + "Добавить заметку" + "Выход")
                        while (true) {
                            noteMenu.print()
                            ...
                            if (noteChoice == archive.notes.size) {
                                ...
                                val viewNoteMenu = Menu(note.title, listOf(note.text, "Назад"))
                                while (true) {
                                    viewNoteMenu.print()
